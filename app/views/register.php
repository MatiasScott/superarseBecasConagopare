...
<body class="bg-gray-50 flex items-center justify-center min-h-screen py-12">
    ...
    <div class="register-card bg-white p-10 rounded-xl w-full max-w-3xl border border-gray-200">
        ...
        <form action="/landing_becasconagopare/public/register" method="POST">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between mt-8 pt-4 border-t border-gray-200">
                ...
                <div class="flex flex-col sm:flex-row gap-4 items-center">
                    <a href="/landing_becasconagopare/public/dashboard-admin" class="inline-block align-baseline font-semibold text-sm text-blue-600 hover:text-blue-800 transition duration-150 ease-in-out">
                        Regresar
                    </a>
                </div>
            </div>
        ...
        <div class="relative top-20 mx-auto p-6 border w-96 shadow-2xl rounded-xl bg-white">
            <div class="mt-3 text-center">
                ...
                <div class="items-center px-4 py-3">
                    <button id="ok-btn" onclick="window.location.href='/landing_becasconagopare/public/login'" class="px-4 py-2 bg-emerald-600 text-white text-base font-medium rounded-lg w-full shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-300">
                        Ir a Iniciar Sesión
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        if (okBtn) {
            okBtn.addEventListener('click', () => {
                window.location.href = '/landing_becasconagopare/public/login';
            });
        }
    </script>
    <script src="/js/cantonParroquia.js"></script>
</body>
