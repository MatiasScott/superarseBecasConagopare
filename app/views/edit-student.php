...
<body class="bg-gray-100 p-8">
    ...
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <form action="<?= htmlspecialchars(app_url('/edit-student/' . (int)($studentSafe['id'] ?? 0))) ?>" method="POST">
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="modalidad" name="modalidad" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            <option value="">Seleccione</option>
                            <option value="Presencial" <?= ($studentSafe['modalidad'] ?? '') === 'Presencial' ? 'selected' : '' ?>>Presencial</option>
                            <option value="Virtual" <?= ($studentSafe['modalidad'] ?? '') === 'Virtual' ? 'selected' : '' ?>>Virtual</option>
                            <option value="Híbrida" <?= ($studentSafe['modalidad'] ?? '') === 'Híbrida' ? 'selected' : '' ?>>Híbrida</option>
                        </select>
                    </div>
